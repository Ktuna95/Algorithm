...
//         code.push(terms[i].split(" ")[0]);
//         num.push(terms[i].split(" ")[1]);
//     }
...
//         year = privacie[0].split(".")[0];
//         month = privacie[0].split(".")[1];
//         day = privacie[0].split(".")[2];
//         code2 = privacie[1];
        
//         let num2 = num[code.indexOf(code2)]; 
//         let assemble = 0;
        
//         assemble += (y - year) * 12 * 28;
//         assemble += (m - month) * 28;
//         assemble += (d - day);
//         if((num*28)<=assemble) {answer.push(i+1)}
//     }
//     return answer;
// }
function solution(today, terms, privacies) {
